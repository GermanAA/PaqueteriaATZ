...
<body>
  <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="#" class="brand-logo">ATZ</a>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        <br><br>
        <h1 class="header center  text-lighten-2">Paquetería ATZ</h1>
        
        <div class="row center">
          <h5 class="header col s12 light">Una solución justo a tu medida.</h5>
        </div>
      ...
      <div class="row">
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="">Puntualidad: Estamos convencidos que el tiempo es un recurso invaluable, por esta razón nuestro objetivo será llegar siempre a tiempo. </p>
            <p class="">Responsabilidad: Comprometidos en conservar en buen estado sus mercancias y transportarlas de forma segura. </p>
            <p class="">Honestidad: Actuamos con honestidad e integridad hacia todos los integrantes de la cadena de valor. </p>
          </div>
        </div>
    ...
    <div class="section">
      ...
      <div class="row">
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Puebla</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Tlaxcala</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Hidalgo</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Veracruz</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Tabasco</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Chiapas</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Campeche</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Yucatán</span>
        ...
        <div class="col s12 l4">
          ...
          <div class="card blue-grey darken-1">
            <div class="card-content white-text">
              <span class="card-title">Quintana Roo</span>
